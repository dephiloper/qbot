...
export class Vector2 extends PIXI.Point {
  ...
  public static subtractValue(vector: Vector2, value: number): Vector2 {
    return new Vector2(vector.x - value, vector.y - value)
  }

  public static multiply(vector: Vector2, value: number): Vector2 {
    return new Vector2(vector.x * value, vector.y * value)
  }

  public static divide(vector: Vector2, value: number): Vector2 {
    return new Vector2(vector.x / value, vector.y / value)
  }
  ...
  public static equalsRounded(vector1: Vector2, vector2: Vector2, roundingFactor: number = 12): boolean {
    const vector = Vector2.abs(Vector2.subtract(vector1, vector2))
  ...
  /**
    ...
    */
  public static truncate(vector: Vector2, max: number): Vector2 {
    if (vector.length > max) {
      return Vector2.multiply(Vector2.normalize(vector), max)
    }
  ...
  /**
    ...
    */
  public static perp(vector: Vector2): Vector2 {
  ...
  /**
    ...
    */
  public static reverse(vector: Vector2): Vector2 {
    return new Vector2(-vector.x, -vector.y)
  }

  public static abs(vector: Vector2): Vector2 {
  ...
  /**
    ...
    */
  public static sign(vector1: Vector2, vector2: Vector2): number {
  ...
  public static angle(vector: Vector2): number {
    const origin = new Vector2(0, -1)
    const radian = Math.acos(Vector2.dot(vector, origin) / (vector.length * origin.length))
    return Vector2.sign(vector, origin) === 1 ? ((Math.PI * 2) - radian) : radian
  }

  public static random(maxX: number, maxY: number): Vector2 {
